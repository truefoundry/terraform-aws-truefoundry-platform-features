...
output "tenant_name" {
  ...
  value       = var.cluster_integration_enabled ? module.integrations.tenant_name : ""
}

output "cluster_token" {
  description = "The cluster token"
  value       = var.cluster_integration_enabled ? module.integrations.cluster_token : ""
}

output "cluster_id" {
  description = "The cluster id"
  value       = var.cluster_integration_enabled ? module.integrations.cluster_id : ""
}
